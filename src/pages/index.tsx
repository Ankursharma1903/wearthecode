...
export default function Home() {
  return (
    <>
      <Head>
        <title>WearTheCode.com - make the code</title>
        <meta name="description" content="WearTheCode.com - make the code" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear The Code with WearTheCode.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the code u made Wear The code u like &#9829;.</p>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the code u made Wear The code u like &#9829;.</p>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the code u made Wear The code u like &#9829;.</p>
    </div>
