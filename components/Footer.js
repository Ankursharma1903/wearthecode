...
<span>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <span className="sm:ml-auto px-4 sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">
            Wear the &lt;code /&gt; premium tshirts,hoodies and apparals 
            </span>
          </div>
